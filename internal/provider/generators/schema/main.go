...
import (
	...
	"github.com/volcengine/terraform-provider-volcenginecc/internal/provider/generators/common"
...
func run(destinationPackage, generatedCodeRootDirectoryName, resourcesFilename, singularDatasourcesFilename, pluralDatasourcesFilename, importExamplesFilename string) int {
	...
	envAK := os.Getenv("VOLCENGINE_ACCESS_KEY")
	envSK := os.Getenv("VOLCENGINE_SECRET_KEY")
	envRegion := os.Getenv("VOLCENGINE_REGION")
	envEndpoint := os.Getenv("VOLCENGINE_ENDPOINT")
