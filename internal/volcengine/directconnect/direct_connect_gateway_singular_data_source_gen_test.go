...
func TestAccVolcengineDirectConnectDirectConnectGatewayDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "Volcengine::DirectConnect::DirectConnectGateway", "volcenginecc_directconnect_direct_connect_gateway", "test")
...
func TestAccVolcengineDirectConnectDirectConnectGatewayDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "Volcengine::DirectConnect::DirectConnectGateway", "volcenginecc_directconnect_direct_connect_gateway", "test")
