...
func init() {
	registry.AddDataSourceFactory("volcenginecc_vedbm_endpoint", endpointDataSource)
}

// endpointDataSource returns the Terraform volcenginecc_vedbm_endpoint data source.
