...
func TestAccVolcengineVEFAASTimerDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "Volcengine::VEFAAS::Timer", "volcenginecc_vefaas_timer", "test")
...
func TestAccVolcengineVEFAASTimerDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "Volcengine::VEFAAS::Timer", "volcenginecc_vefaas_timer", "test")
