...
func init() {
	registry.AddDataSourceFactory("volcenginecc_vpc_securitygroup", securityGroupDataSource)
}

// securityGroupDataSource returns the Terraform volcenginecc_vpc_securitygroup data source.
