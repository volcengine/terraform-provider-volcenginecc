...
func TestAccVolcengineVPCENIDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "Volcengine::VPC::ENI", "volcenginecc_vpc_eni", "test")
...
func TestAccVolcengineVPCENIDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "Volcengine::VPC::ENI", "volcenginecc_vpc_eni", "test")
