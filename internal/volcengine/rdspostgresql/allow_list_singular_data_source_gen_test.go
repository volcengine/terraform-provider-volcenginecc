...
func TestAccVolcengineRDSPostgreSQLAllowListDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "Volcengine::RDSPostgreSQL::AllowList", "volcenginecc_rdspostgresql_allow_list", "test")
...
func TestAccVolcengineRDSPostgreSQLAllowListDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "Volcengine::RDSPostgreSQL::AllowList", "volcenginecc_rdspostgresql_allow_list", "test")
