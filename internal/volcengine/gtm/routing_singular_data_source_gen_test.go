...
func TestAccVolcengineGTMRoutingDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "Volcengine::GTM::Routing", "volcenginecc_gtm_routing", "test")
...
func TestAccVolcengineGTMRoutingDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "Volcengine::GTM::Routing", "volcenginecc_gtm_routing", "test")
