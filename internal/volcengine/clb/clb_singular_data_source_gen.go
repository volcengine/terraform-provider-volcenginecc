...
func cLBDataSource(ctx context.Context) (datasource.DataSource, error) {
	attributes := map[string]schema.Attribute{ /*START SCHEMA*/
		...
		//	  "type": "array"
		//	}
		"allowed_ports": schema.ListAttribute{ /*START ATTRIBUTE*/
		...
		"eip": schema.SingleNestedAttribute{ /*START ATTRIBUTE*/
			Attributes: map[string]schema.Attribute{ /*START SCHEMA*/
				...
				"security_protection_types": schema.ListAttribute{ /*START ATTRIBUTE*/
					ElementType: types.StringType,
					Description: "安全防护类型",
					Computed:    true,
				}, /*END ATTRIBUTE*/
		...
		//	  "type": "array"
		//	}
		"server_groups": schema.ListNestedAttribute{ /*START ATTRIBUTE*/
			NestedObject: schema.NestedAttributeObject{ /*START NESTED OBJECT*/
				Attributes: map[string]schema.Attribute{ /*START SCHEMA*/
