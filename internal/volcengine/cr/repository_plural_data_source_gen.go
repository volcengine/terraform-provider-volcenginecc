...
func init() {
	registry.AddDataSourceFactory("volcenginecc_cr_repositories", repositoriesDataSource)
}

// repositoriesDataSource returns the Terraform volcenginecc_cr_repositories data source.
...
func repositoriesDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	opts = opts.WithCloudControlTypeName("Volcengine::CR::Repository").WithTerraformTypeName("volcenginecc_cr_repositories")
