...
func TestAccVolcenginePrivateLinkVpcEndpointDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "Volcengine::PrivateLink::VpcEndpoint", "volcenginecc_privatelink_vpc_endpoint", "test")
...
func TestAccVolcenginePrivateLinkVpcEndpointDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "Volcengine::PrivateLink::VpcEndpoint", "volcenginecc_privatelink_vpc_endpoint", "test")
