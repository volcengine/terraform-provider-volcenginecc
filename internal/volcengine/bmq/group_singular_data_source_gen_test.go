...
func TestAccVolcengineBMQGroupDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "Volcengine::BMQ::Group", "volcenginecc_bmq_group", "test")
...
func TestAccVolcengineBMQGroupDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "Volcengine::BMQ::Group", "volcenginecc_bmq_group", "test")
