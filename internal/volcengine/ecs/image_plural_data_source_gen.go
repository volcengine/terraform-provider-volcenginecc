...
func init() {
	registry.AddDataSourceFactory("volcenginecc_ecs_images", imagesDataSource)
}

// imagesDataSource returns the Terraform volcenginecc_ecs_images data source.
...
func imagesDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	opts = opts.WithCloudControlTypeName("Volcengine::ECS::Image").WithTerraformTypeName("volcenginecc_ecs_images")
