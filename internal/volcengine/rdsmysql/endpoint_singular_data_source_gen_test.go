...
func TestAccVolcengineRDSMySQLEndpointDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "Volcengine::RDSMySQL::Endpoint", "volcenginecc_rdsmysql_endpoint", "test")
...
func TestAccVolcengineRDSMySQLEndpointDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "Volcengine::RDSMySQL::Endpoint", "volcenginecc_rdsmysql_endpoint", "test")
