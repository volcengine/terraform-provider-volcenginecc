...
func TestAccVolcengineTransitRouterTransitRouterDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "Volcengine::TransitRouter::TransitRouter", "volcenginecc_transitrouter_transit_router", "test")
...
func TestAccVolcengineTransitRouterTransitRouterDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "Volcengine::TransitRouter::TransitRouter", "volcenginecc_transitrouter_transit_router", "test")
