...
func init() {
	registry.AddDataSourceFactory("volcenginecc_transitrouter_transitrouter", transitRouterDataSource)
}

// transitRouterDataSource returns the Terraform volcenginecc_transitrouter_transitrouter data source.
