...
func init() {
	registry.AddDataSourceFactory("volcenginecc_iam_accesskeys", accesskeysDataSource)
}

// accesskeysDataSource returns the Terraform volcenginecc_iam_accesskeys data source.
...
func accesskeysDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	opts = opts.WithCloudControlTypeName("Volcengine::IAM::Accesskey").WithTerraformTypeName("volcenginecc_iam_accesskeys")
