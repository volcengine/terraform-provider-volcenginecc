...
func init() {
	registry.AddDataSourceFactory("volcenginecc_cdn_domain", domainDataSource)
}

// domainDataSource returns the Terraform volcenginecc_cdn_domain data source.
// This Terraform data source corresponds to the Cloud Control Volcengine::CDN::Domain resource.
