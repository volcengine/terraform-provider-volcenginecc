...
func TestAccVolcengineCDNShareConfigDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "Volcengine::CDN::ShareConfig", "volcenginecc_cdn_share_config", "test")
...
func TestAccVolcengineCDNShareConfigDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "Volcengine::CDN::ShareConfig", "volcenginecc_cdn_share_config", "test")
