...
func TestAccVolcengineEBSVolumeDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "Volcengine::EBS::Volume", "volcenginecc_ebs_volume", "test")
...
func TestAccVolcengineEBSVolumeDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "Volcengine::EBS::Volume", "volcenginecc_ebs_volume", "test")
