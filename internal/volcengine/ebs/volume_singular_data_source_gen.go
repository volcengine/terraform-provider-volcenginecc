...
func init() {
	registry.AddDataSourceFactory("volcenginecc_ebs_volume", volumeDataSource)
}

// volumeDataSource returns the Terraform volcenginecc_ebs_volume data source.
...
func volumeDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Volcengine::EBS::Volume",
