...
func init() {
	registry.AddDataSourceFactory("volcenginecc_vpn_vpn_connection", vPNConnectionDataSource)
}

// vPNConnectionDataSource returns the Terraform volcenginecc_vpn_vpn_connection data source.
// This Terraform data source corresponds to the Cloud Control Volcengine::VPN::VPNConnection resource.
