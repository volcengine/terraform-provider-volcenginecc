...
func TestAccVolcengineCloudIdentityUserDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "Volcengine::CloudIdentity::User", "volcenginecc_cloudidentity_user", "test")
...
func TestAccVolcengineCloudIdentityUserDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "Volcengine::CloudIdentity::User", "volcenginecc_cloudidentity_user", "test")
