...
func init() {
	registry.AddDataSourceFactory("volcenginecc_rocketmq_instance", instanceDataSource)
}

// instanceDataSource returns the Terraform volcenginecc_rocketmq_instance data source.
// This Terraform data source corresponds to the Cloud Control Volcengine::RocketMQ::Instance resource.
