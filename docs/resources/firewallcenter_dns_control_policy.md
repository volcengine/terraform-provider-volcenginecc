---
page_title: "volcenginecc_firewallcenter_dns_control_policy Resource - terraform-provider-volcenginecc"
subcategory: ""
description: |-
  域名黑名单访问控制策略。
---

# volcenginecc_firewallcenter_dns_control_policy (Resource)
...
```shell
$ terraform import volcenginecc_firewallcenter_dns_control_policy.example "rule_id"
```